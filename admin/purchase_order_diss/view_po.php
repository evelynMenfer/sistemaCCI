...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url . '/admin?page=purchase_order_diss/manage_po&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-danger" href="<?php echo base_url . '/admin?page=purchase_order_diss' ?>">Volver</a>
    </div>
</div>
