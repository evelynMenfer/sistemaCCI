...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url . '/admin?page=purchase_order_succes/manage_po&id=' . (isset($id) ? $id : '') ?>">Editar</a>
        <a class="btn btn-flat btn-danger" href="<?php echo base_url . '/admin?page=purchase_order_succes' ?>">Volver</a>
    </div>
</div>
    ...
    $(function () {
        $('#print').click(function () {
            ...
            _el.append('<div class="d-flex justify-content-center">' +
                ...
                '<img src="<?php echo validate_image($logo_empresa) ?>" width="1100px" height="50px"/>' +
                '</div><hr/>')
            _el.append( 
                ...
                '                    style="font-size: 12px; color: #009966;">OAXACA DE JUÁREZ, OAXACA, </span></td>' +
                '        </tr>' +
                '    </thead>' +
                '    <tbody>' +
                '        <tr style="height: 18px;">' +
                ...
                '                    style="font-size: 12px; color: #009966;">COTIZACIÓN:' +
                '                    </span></td>' +
