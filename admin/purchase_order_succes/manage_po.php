...
<div class="card card-outline card-primary">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="id_company" id="id_company" class="custom-select select2">
                                ...
                                <?php
                                $supplier = $conn->query("SELECT * FROM `company_list` where status = 1 and id = 4 order by `name` asc");
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-danger"
            href="<?php echo base_url . '/admin?page=purchase_order_succes' ?>">Cancelar</a>
    </div>
</div>
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.status == 'success') {
                        location.replace(_base_url_ + "admin/?page=purchase_order_succes/view_po&id=" + resp.id);
