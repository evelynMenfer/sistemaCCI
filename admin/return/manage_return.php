...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="return-form">Guardar</button>
        <a class="btn btn-flat btn-danger" href="<?php echo base_url . '/admin?page=return' ?>">Cancelar</a>
    </div>
</div>
