<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">PROVEEDORA COMERCIAL HELMES</h3>
        <div class="card-tools">
            <a href="<?php echo base_url ?>admin/?page=purchase_order_helmes/manage_po" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Nueva Cotización</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = $conn->query("SELECT p.*, c.name as company FROM `purchase_order_list` p inner join company_list c on c.id = p.id_company and c.id = 6 order by p.`date_created` desc;");                        
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <?php endif; ?>
                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=purchase_order_helmes/view_po&id=' . $row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Ver</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=purchase_order_helmes/manage_po&id=' . $row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Editar</a>
                                        <div class="dropdown-divider"></div>
