                ...
                <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <nav class="mt-4">
                        <ul class="nav nav-pills nav-sidebar flex-column text-md nav-compact nav-flat nav-child-indent nav-collapse-hide-child"
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url ?>admin/?page=purchase_order_cenit"
                                    class="nav-link nav-purchase_order_cenit">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url ?>admin/?page=purchase_order_succes"
                                    class="nav-link nav-purchase_order_succes">
                                    <i class="nav-icon fas fa-th-list"></i>
                                    <p>
                                        SUCCES
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url ?>admin/?page=purchase_order_helmes"
                                    class="nav-link nav-purchase_order_helmes">
                                    <i class="nav-icon fas fa-th-list"></i>
                                    <p>
                                        HELMES
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url ?>admin/?page=purchase_order_kalahari"
                                    class="nav-link nav-purchase_order_kalahari">
                                    <i class="nav-icon fas fa-th-list"></i>
                                    <p>
                                        KALAHARI
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url ?>admin/?page=purchase_order_diss"
                                    class="nav-link nav-purchase_order_diss">
                                    <i class="nav-icon fas fa-th-list"></i>
                                    <p>
                                        DISS
                                    </p>
