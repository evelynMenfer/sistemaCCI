...
<div class="container-fluid">
	<form action="" id="company-form">
		...
		<div class="form-group">
			...
			<input name="rfc" id="rfc" class="form-control rounded-0" value="<?php echo isset($rfc) ? $rfc : ''; ?>">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="cperson" class="control-label">Persona de Contacto</label>
			<input name="cperson" id="cperson" class="form-control rounded-0" value="<?php echo isset($cperson) ? $cperson : ''; ?>">
		</div>
		<div class="form-group">
			<label for="contact" class="control-label"># de Contacto</label>
