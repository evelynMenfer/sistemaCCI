...
<div class="container-fluid">
	<form action="" id="item-form">
		...
		<div class="form-group">
			<label for="description" class="control-label">Descripción (agregar \ antes de ", ej. 12\")</label>
			<textarea name="description" id="description" cols="30" rows="2"
				class="form-control form no-resize"><?php echo isset($description) ? $description : ''; ?></textarea>
		</div>
		<div class="form-group">
			<label for="stock" class="control-label">Stock</label>
			<input type="number" name="stock" id="stock" step="any" class="form-control rounded-0 text-end"
		...
		<div class="form-group">
			...
			<input type="number" name="product_cost" id="product_cost" step="any"
				...
				value="<?php echo isset($product_cost) ? $product_cost : ''; ?>">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="number" name="shipping_or_extras" id="shipping_or_extras" step="any"
				class="form-control rounded-0 text-end"
				value="<?php echo isset($shipping_or_extras) ? $shipping_or_extras : ''; ?>">
		</div>
		<div class="form-group">
			<label for="date_purchase" class="control-label">Fecha de Compra</label>
			<input type="date" name="date_purchase" id="date_purchase" step="any"
				class="form-control rounded-0 text-end"
				value="<?php echo isset($date_purchase) ? $date_purchase : ''; ?>">
		</div>

		<div class="form-group">
			<label for="oc" class="control-label">OC</label>
			<input type="text" name="oc" id="oc" step="any" class="form-control rounded-0 text-end"
